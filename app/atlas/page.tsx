        ...
        {title && (
          <div className="flex items-center justify-between gap-2" style={{ padding: "clamp(8px, 2vw, 12px) clamp(12px, 3vw, 16px)", borderBottom: "1px solid var(--border)", background: "rgba(255,255,255,0.02)" }}>
            <div className="flex items-center gap-2 min-w-0">
              <Terminal size={13} className="text-[var(--accent)] shrink-0 sm:w-[14px] sm:h-[14px]" />
...
function StepCard({ num, title, badge, children }: { num: number; title: string; badge?: string; children: React.ReactNode }) {
  return (
    <div className="rounded-xl" style={{ padding: "clamp(14px, 3vw, 24px)", background: "rgba(255,255,255,0.02)", border: "1px solid var(--border)" }}>
      <div className="flex items-start gap-2.5 sm:gap-3" style={{ marginBottom: "clamp(10px, 2.5vw, 16px)" }}>
        <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-full flex items-center justify-center shrink-0 text-[12px] sm:text-[14px] font-bold font-display"
    ...
    <div style={{ background: "var(--bg-deep)", minHeight: "100vh" }}>
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl" style={{ background: "rgba(8,8,8,0.6)", borderBottom: "1px solid var(--border)" }}>
        <div className="w-full flex items-center justify-between gap-3 sm:gap-4" style={{ padding: "clamp(12px, 2vw, 18px) clamp(24px, 5vw, 64px)" }}>
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            <Shield size={16} className="text-[var(--accent)] shrink-0 sm:w-[18px] sm:h-[18px]" />
            <span className="font-display font-bold text-[var(--text-primary)] text-[13px] sm:text-base truncate">Atlas Secure</span>
          </div>
          <LangSwitcher />
        </div>
      </header>
      ...
      <main className="max-w-[1200px] mx-auto" style={{ padding: "clamp(24px, 5vw, 48px) clamp(24px, 5vw, 64px) clamp(48px, 8vw, 80px)" }}>
        ...
        <div className="text-center" style={{ marginBottom: "clamp(24px, 4vw, 32px)" }}>
          <div className="flex items-center justify-center gap-2" style={{ marginBottom: "clamp(10px, 2vw, 16px)" }}>
        ...
        <div style={{ marginTop: "clamp(32px, 5vw, 48px)" }}>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            <a href="#" className="flex items-center justify-center gap-2 sm:gap-2.5 rounded-xl font-medium text-[13px] sm:text-sm transition-all duration-300 hover:border-[var(--border-accent)] hover:text-[var(--accent)]"
              style={{ padding: "clamp(12px, 3vw, 16px)", background: "var(--bg-card)", border: "1px solid var(--border)", color: "var(--text-primary)" }}>
              <Monitor size={16} className="sm:w-[18px] sm:h-[18px]" /> Windows
            </a>
            <a href="#" className="flex items-center justify-center gap-2 sm:gap-2.5 rounded-xl font-medium text-[13px] sm:text-sm transition-all duration-300 hover:border-[var(--border-accent)] hover:text-[var(--accent)]"
              style={{ padding: "clamp(12px, 3vw, 16px)", background: "var(--bg-card)", border: "1px solid var(--border)", color: "var(--text-primary)" }}>
              <Laptop size={16} className="sm:w-[18px] sm:h-[18px]" /> macOS
            </a>
          </div>
        </div>
        ...
        {/* ═══ SUPPORT CARD ═══ */}
        <div className="rounded-2xl text-center" style={{ marginTop: "clamp(24px, 4vw, 36px)", padding: "clamp(20px, 5vw, 40px)", background: "linear-gradient(135deg, var(--bg-card) 0%, #0f1a0f 100%)", border: "1px solid var(--border-accent)" }}>
          <Shield size={24} className="mx-auto mb-3 text-[var(--accent)] sm:w-7 sm:h-7" />
